...
if __name__ == "__main__":
    ...
    parser.add_argument('time_duration', help='How long should we keep the splash screen displayed!')
    ...
    time_duration = int(args.time_duration)    # s
    root.after(time_duration*1000, root.destroy)
